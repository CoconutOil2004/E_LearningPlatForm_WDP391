  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          className="absolute w-64 h-64 rounded-full auth-blob -top-20 left-1/4 opacity-30"
          style={{
            background:
        ...
        />
        <div
          className="absolute rounded-full opacity-25 auth-blob-delay -bottom-16 right-1/4 w-72 h-72"
          style={{
            background:
