...
const SignUp = () => {
  ...
  return (
    <div
      className="relative flex items-center justify-center min-h-screen px-4 py-10 overflow-hidden"
      style={{ background: "var(--gradient-hero)" }}
    >
      {/* Blobs */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          className="absolute rounded-full auth-blob -top-16 -right-16 w-72 h-72 opacity-30"
          style={{
            background:
        ...
        />
        <div
          className="absolute rounded-full opacity-25 auth-blob-delay -bottom-20 -left-20 w-80 h-80"
          style={{
            background:
        ...
        />
        <div
          className="absolute w-40 h-40 rounded-full auth-blob top-1/2 right-1/3 opacity-20"
          style={{
            background:
