...
const StoreRegistration = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r section-hero py-12 px-4 sm:px-6 lg:px-8">
      <motion.div 
      ...
      >
        <div>
          <h2 className="mt-2 text-center text-3xl font-extrabold text-heading">
            Register as Seller
          </h2>
        ...
        <form className="mt-6 space-y-5" onSubmit={handleSubmit}>
          <div className="rounded-md shadow-sm space-y-4">
            {/* Store Name */}
            <div>
              <label htmlFor="storeName" className="block text-sm font-medium text-body">
                Store Name
              </label>
              <input
                id="storeName"
            ...
            {/* Banner Image URL */}
            <div>
              <label htmlFor="bannerImageURL" className="block text-sm font-medium text-body">
