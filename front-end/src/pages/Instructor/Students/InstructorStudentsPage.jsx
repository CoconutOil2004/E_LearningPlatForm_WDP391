      ...
      render: (_, record) => (
        <Space>
          <img
            ...
            alt=""
            className="object-cover w-10 h-6 border border-gray-100 rounded shadow-sm"
          />
      ...
      render: (_, record) => (
        <div className="flex flex-col gap-1 pr-4">
          <div className="flex justify-between items-center text-[12px]">
            ...
            <Text
              strong
              style={{ color: record.completed ? COLOR.green : COLOR.ocean }}
            >
              {record.progress}%
            </Text>
          </div>
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex justify-between gap-4">
          <Input
            ...
            size="large"
            className="max-w-md transition-all border-gray-100 shadow-sm rounded-xl focus:shadow-md"
            value={searchText}
        ...
        <Card
          bordered={false}
          className="overflow-hidden border border-gray-100 shadow-xl rounded-3xl"
          bodyStyle={{ padding: 0 }}
        >
          <ConfigProvider
            theme={{
